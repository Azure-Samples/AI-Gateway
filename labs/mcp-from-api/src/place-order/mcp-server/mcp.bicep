...
param operationName string = 'PlaceOrder-invoke'

param mcpPath string = 'order-mcp'
param mcpName string = 'order-mcp'
param mcpDisplayName string = 'Place Order MCP'
param mcpDescription string = 'MCP for placing order'
