---
name: Azure AI Foundry Private Connectivity with MCP
architectureDiagram: images/mcp-private-endpoint-entra-id.gif
categories:
  - AI Agents
  - Knowledge & Tools
...
![architecture](../../images/mcp-private-endpoint-entra-id.gif)
