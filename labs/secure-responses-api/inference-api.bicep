...
resource api 'Microsoft.ApiManagement/service/apis@2024-06-01-preview' = {
  ...
  properties: {
    ...
    type: 'http'
    // Pulling this from the spec referenced in this document:  https://learn.microsoft.com/en-us/azure/ai-foundry/openai/api-version-lifecycle?tabs=key#v1-api-support
    // I was going to copy the spec file locally, but it was to large to stream into the bicep file
    value: 'https://raw.githubusercontent.com/Azure/azure-rest-api-specs/main/specification/ai/data-plane/OpenAI.v1/azure-v1-v1-generated.json'
  }
}
